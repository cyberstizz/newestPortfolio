...
const projects = [
  ...
  {
    name: 'Danys Pizza',
    description: 'this is a Pizza shop that also sells other delicious food',
    image: DanysScreenshot,
    source_code_link: 'https://github.com/cyberstizz/MogulFashion',
    demo_link: 'https://danys-472019.webflow.io/',
  },
  {
    name: 'EasyCode',
    ...
    image: EasyCodeScreenshot,
    source_code_link: 'https://github.com/cyberstizz/theGuttiesOutlet.git',
    demo_link: 'https://easycodedesigns-46fd06.webflow.io/',
  },
  {
    name: 'Basic Bank',
